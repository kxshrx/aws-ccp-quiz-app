    ...
    <div className="min-h-screen bg-gradient-to-br from-palette-cream via-palette-warm-white to-palette-light-blue">
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          {score.percentage < 80 && (
            <div className="bg-white rounded-3xl shadow-2xl p-10 border-2 border-palette-cream">
              <h3 className="text-3xl font-bold text-palette-charcoal mb-8 flex items-center justify-center space-x-3">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-palette-light-blue rounded-2xl p-6 border-2 border-palette-blue">
                  <div className="flex items-start space-x-4">
                    <svg className="w-8 h-8 text-palette-blue flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div>
                      <h4 className="text-xl font-bold text-palette-navy mb-2">Review AWS Documentation</h4>
                      <p className="text-lg text-palette-navy">Study official AWS whitepapers and service documentation</p>
                    </div>
                  </div>
                </div>
                <div className="bg-orange-50 rounded-2xl p-6 border-2 border-orange-200">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-orange-800 mb-2">Practice More Questions</h4>
                      <p className="text-lg text-orange-700">Take more practice exams to identify weak areas</p>
                    </div>
                  </div>
                </div>
              </div>
