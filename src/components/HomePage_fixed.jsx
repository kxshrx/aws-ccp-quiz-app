      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border-2 border-palette-cream hover:shadow-3xl transition-all duration-300">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border-2 border-palette-cream hover:shadow-3xl transition-all duration-300">
              ...
              <button 
                className="w-full py-4 px-6 bg-palette-blue text-white rounded-2xl text-lg font-semibold hover:bg-opacity-90 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105"
